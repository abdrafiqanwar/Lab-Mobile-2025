...
public class BookData {
    ...
    static {
        books.add(new Book("Laskar Pelangi", "Andrea Hirata", 2005,
                ...
                Uri.parse("android.resource://com.example.praktikum5/" + R.drawable.book1).toString(),
                false, 4.8f, "Drama"));

        books.add(new Book("Bumi Manusia", "Pramoedya Ananta Toer", 1980,
                "Kisah cinta dan perjuangan di masa kolonial Belanda.",
                Uri.parse("android.resource://com.example.praktikum5/" + R.drawable.book2).toString(),
                false, 4.9f, "History"));

        books.add(new Book("Negeri 5 Menara", "Ahmad Fuadi", 2009,
                "Perjalanan hidup santri dengan mimpi besar di pesantren.",
                Uri.parse("android.resource://com.example.praktikum5/" + R.drawable.book3).toString(),
        ...
        books.add(new Book("Supernova: Ksatria, Puteri, dan Bintang Jatuh", "Dee Lestari", 2001,
                ...
                Uri.parse("android.resource://com.example.praktikum5/" + R.drawable.book4).toString(),
                false, 4.6f, "Fiction"));

        books.add(new Book("Ayat-Ayat Cinta", "Habiburrahman El Shirazy", 2004,
                "Kisah cinta Islami yang penuh nilai moral.",
                Uri.parse("android.resource://com.example.praktikum5/" + R.drawable.book5).toString(),
                false, 4.5f, "Romance"));
        ...
        books.add(new Book("The Wedding People", "Alison Espach", 2024,
                ...
                Uri.parse("android.resource://com.example.praktikum5/" + R.drawable.book6).toString(),
                false, 4.6f, "Fiction"));
        ...
        books.add(new Book("Where the Crawdads Sing", "Delia Owens", 2018,
                ...
                Uri.parse("android.resource://com.example.praktikum5/" + R.drawable.book7).toString(),
                false, 4.5f, "Fiction"));
        ...
        books.add(new Book("Sapiens: A Brief History of Humankind", "Yuval Noah Harari", 2011,
                ...
                Uri.parse("android.resource://com.example.praktikum5/" + R.drawable.book8).toString(),
        ...
        books.add(new Book("The Name of the Wind", "Patrick Rothfuss", 2007,
                ...
                Uri.parse("android.resource://com.example.praktikum5/" + R.drawable.book9).toString(),
                false, 4.8f, "Fantasy"));
        ...
        books.add(new Book("The Diary of a Young Girl", "Anne Frank", 1947,
                ...
                Uri.parse("android.resource://com.example.praktikum5/" + R.drawable.book10).toString(),
        ...
        books.add(new Book("Guns, Germs, and Steel", "Jared Diamond", 1997,
                ...
                Uri.parse("android.resource://com.example.praktikum5/" + R.drawable.book11).toString(),
                false, 4.4f, "History"));
        ...
        books.add(new Book("And the Mountains Echoed", "Khaled Hosseini", 2013,
                ...
                Uri.parse("android.resource://com.example.praktikum5/" + R.drawable.book12).toString(),
        ...
        books.add(new Book("Gone Girl", "Gillian Flynn", 2012,
                ...
                Uri.parse("android.resource://com.example.praktikum5/" + R.drawable.book13).toString(),
                false, 4.2f, "Mystery"));
        ...
        books.add(new Book("The Shining", "Stephen King", 1977,
                ...
                Uri.parse("android.resource://com.example.praktikum5/" + R.drawable.book14).toString(),
                false, 4.5f, "Horror"));
        ...
        books.add(new Book("A Thousand Splendid Suns", "Khaled Hosseini", 2007,
                ...
                Uri.parse("android.resource://com.example.praktikum5/" + R.drawable.book15).toString(),
                false, 4.7f, "Drama"));
